  ...
  return (function(e) {
    ...
    0: function(e, t, i) {
      ...
      const a = e => document.querySelector(e),
        ...
        d = e => 0.299 * e.r + 0.587 * e.g + 0.114 * e.b;
    },
    1: function(e, t, i) {
      "use strict";
      i.d(t, "a", function() {
      ...
      (r.register = (e, t) => (r[e] = e => new t(e))), (r.version = "0.5.4");
      const h = function() {
        return (
      ...
      (r.VantaBase = class {
        constructor(e = {}) {
          ...
          if (
            ...
            const e = this.el;
            if (((this.el = Object(s.f)(e)), !this.el))
    ...
    15: function(e, t, i) {
      ...
      var s = i(3),
        n = i(0);
      let o = "object" == typeof window && window.p5;
      class r extends s.b {
        static initClass() {
          (this.prototype.p5 = !0),
        ...
        onInit() {
          const e = this;
          this.p5 = new o(function(t) {
            let i = Object(n.e)() ? 35 : 55,
              s = 50,
              o = 4,
              r = 0.2,
              h = 0.12,
            ...
            function l(e, i, s) {
              ...
              return (
                n < 0 && (n += t.TWO_PI),
                t.noise(u + t.cos(n) * i, c + t.sin(n) * i, d + s)
              );
            }
            (t.setup = function() {
              e.initP5(t),
                  ...
                  (function() {
                    ...
                    for (let n = 0; n < i; n++) {
                      ...
                      for (let i = 0; i < 360; i++) {
                        let u = t.radians(i),
                          c =
                            e.options.chaos * a * l(u, h * n + r, d) +
                            (o * n + s) +
                            (n * e.options.spacing || 0);
                        t.vertex(c * t.cos(u), c * t.sin(u));
                      }
                      t.endShape(t.CLOSE);
                    }
                  })();
      ...
      r.initClass(), (t.default = s.a.register("TRUNK", r));
    },
    3: function(e, t, i) {
      "use strict";
      i.d(t, "b", function() {
